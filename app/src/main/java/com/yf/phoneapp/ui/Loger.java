...
public class Loger 
{
	...
	private static final String TAG = "PhoneRadioapp";
	...
	private static void handleLog(int level, String msg, String head)
	{
		...
		/*System.out.println("stackslist.length = " + stackslist.length);

        for(StackTraceElement sts: stackslist)
        {
        	System.out.println("-------" + sts.getMethodName() + " : "+sts);
        }
		*/
